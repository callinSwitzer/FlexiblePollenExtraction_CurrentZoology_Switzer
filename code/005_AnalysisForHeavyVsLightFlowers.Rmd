...
save_plot(file.path(figDir, "003_HeavyLight.tiff"), 
          plot = aa, base_width = 6.5, base_height = 3, dpi = 500, type = "cairo", compression = "lzw")

# save pdf
save_plot(file.path(figDir, "003_HeavyLight.pdf"), 
          plot = aa, base_width = 6.5, base_height = 3)

save_plot(file.path(figDir, "003_HeavyLight_lowRes.png"), 
          plot = aa, base_width = 6.5, base_height = 3, dpi = 500, type = "cairo")
```
